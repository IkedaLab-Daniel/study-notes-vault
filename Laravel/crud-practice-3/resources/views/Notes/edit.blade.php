<x-app-layout>
    <div class="h-full text-gray-50 bg-gray-700 w-[800px] p-4 mx-auto mt-[50px] rounded-xl shadow-lg">
        ...
        >
            ...
            <input placeholder="Title" class="bg-gray-600 w-[100%] rounded-md" type="text" name="title" value="{{ $note->title }}">
            <label class="text-xl" for="message">Message:</label>
            <textarea placeholder="Message" class="bg-gray-600 w-[100%] rounded-md" rows="6" name="message" id="message">{{ $note->message }}</textarea>
